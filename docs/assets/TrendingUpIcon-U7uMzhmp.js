const n=`<template>
  ...
  >
    ...
    >
      <Motion is="polyline" :ref="targetList[1]" points="22 7 13.5 15.5 8.5 10.5 2 17" />
      <Motion is="polyline" :ref="targetList[2]" points="22 7 16 7" />
      <Motion is="polyline" :ref="targetList[3]" points="22 7 22 13" />
    </Motion>
  </div>
</template>
