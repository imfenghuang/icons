<template>
  ...
  >
    ...
    >
      ...
      />
      <Motion is="path" :ref="targetList[1]" d="m6 17 3.13-5.78c.53-.97.1-2.18-.5-3.1a4 4 0 1 1 6.89-4.06" />
      <Motion is="path" :ref="targetList[2]" d="m12 6 3.13 5.73C15.66 12.7 16.9 13 18 13a4 4 0 0 1 0 8" />
    </svg>
  </div>
</template>
